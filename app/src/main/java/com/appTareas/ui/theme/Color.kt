...
val backgroundDialog = hexToColor("#e8e8e8")
val backgroundDialogDarkMode = hexToColor("#1E1E1E")
val surface = hexToColor("#E0E0E0")
val surfaceDarkMode = hexToColor("#2E2E2E")
